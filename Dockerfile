...
COPY droptoken.rds /srv/shiny-server/rjit_benchmarks/
...
COPY execution.R /srv/shiny-server/rjit_benchmarks/
COPY compilation.R /srv/shiny-server/rjit_benchmarks/
COPY .httr-oauth /srv/shiny-server/rjit_benchmarks/
